...
- (bool)textView:(UITextView *)textView
  ...
  // To be sure, we re-run typingAttributes management right before the character
  // actually lands. Sometimes, between a selection change and the next keystroke,
  // typing attributes might get removed - this seems like a native TextKit issue.
  if (range.length == 0 && text.length > 0) {

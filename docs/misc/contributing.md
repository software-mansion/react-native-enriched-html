...
> for linting and formatting, and [Jest](https://jestjs.io/) for testing.note
...
> ```
>
> Always review newly saved screenshots before committing them.note Running Android tests on macOS
...
>   kebab-case.
> * If you make any changes, run `yarn build` before opening a pull request, to make sure the project successfully builds.info

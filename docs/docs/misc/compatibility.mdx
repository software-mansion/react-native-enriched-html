...
The table below assumes you're on the latest patch of each React Native minor
version.

| React Native | Android    | iOS        | Web            |
| ------------ | ---------- | ---------- | -------------- |
| 0.85         | <Yes />    | <Yes />    | <Yes /> (exp.) |
| 0.84         | <Yes />    | <Yes />    | <Yes /> (exp.) |
| 0.83         | <Yes />    | <Yes />    | <Yes /> (exp.) |
| 0.82         | <Yes />    | <Yes />    | <Yes /> (exp.) |
| 0.81         | <Yes />    | <Yes />    | <Yes /> (exp.) |

Android and iOS are fully supported. The Web implementation is still
**experimental** - see the [Web support](/core-functionalities/web-support)
guide for what's covered.

...
characters you have selected, or - if nothing is selected - enables it so the next
characters you type come out styled. This family includes:
...
* **Text alignment** - `setTextAlignment(alignment: 'left' | 'center' | 'right' | 'justify' | 'auto')`

> **Note**
>
> We will not touch list styles or text alignment for now - we'll cover them in-depth in respectively
> [Lists](/rich-text-formatting/lists) and [Text alignment](/rich-text-formatting/text-alignment) sections.
...
> **Info**
>
> This page is about *what* each style does, using the built-in defaults. To change
